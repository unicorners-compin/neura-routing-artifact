...
\input{figures/fig1_shock_response}
...
\input{figures/fig3_stress_tradeoff}
...
\input{figures/fig5_continuous_chaos}
...
\input{figures/tab7_ns3_validation}
\input{figures/tab8_ns3_online_er_validation}
...
\section*{Funding}
This work was supported by the National Key Research and Development Program of China (No. 2023YFC3011502). The funder had no role in the study design, simulation design, data analysis, manuscript preparation, or decision to submit the article for publication.
